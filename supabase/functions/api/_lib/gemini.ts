...
const UK_AUTOMOTIVE_REPLACEMENTS: Array<{ pattern: RegExp; replacement: string }> = [
  { pattern: /ключ для фільтра оливи/gi, replacement: "ключ для масляного фільтра" },
  { pattern: /фільтр моторної оливи/gi, replacement: "масляний фільтр" },
  { pattern: /фільтра моторної оливи/gi, replacement: "масляного фільтра" },
  { pattern: /фільтром моторної оливи/gi, replacement: "масляним фільтром" },
  { pattern: /фільтр оливи/gi, replacement: "масляний фільтр" },
  { pattern: /фільтра оливи/gi, replacement: "масляного фільтра" },
  { pattern: /фільтром оливи/gi, replacement: "масляним фільтром" },
  { pattern: /піддон для зливу оливи/gi, replacement: "піддон для зливу масла" },
  { pattern: /заміна моторної оливи/gi, replacement: "заміна моторного масла" },
  { pattern: /заміна оливи/gi, replacement: "заміна масла" },
  { pattern: /моторної оливи/gi, replacement: "моторного масла" },
  { pattern: /моторну оливу/gi, replacement: "моторне масло" },
  { pattern: /моторна олива/gi, replacement: "моторне масло" },
  { pattern: /оливний/gi, replacement: "масляний" },
  { pattern: /оливного/gi, replacement: "масляного" },
  { pattern: /оливному/gi, replacement: "масляному" },
  { pattern: /оливним/gi, replacement: "масляним" },
  { pattern: /оливі/gi, replacement: "маслі" },
  { pattern: /оливою/gi, replacement: "маслом" },
  { pattern: /оливи/gi, replacement: "масла" },
  { pattern: /олива/gi, replacement: "масло" },
  { pattern: /оливу/gi, replacement: "масло" },
  { pattern: /олія/gi, replacement: "масло" },
  { pattern: /олію/gi, replacement: "масло" },
