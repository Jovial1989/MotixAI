...
class _GuideCreateSheetState extends State<_GuideCreateSheet> {
  ...
  String get _vehicleModel => [_selYear, _selMake, _selModel]
      .where((s) => s != null && s.isNotEmpty)
      .join(' ');

  bool get _step0Valid =>
      _selMake != null && _selModel != null && _selModel!.isNotEmpty;
  ...
  List<Widget> _buildStep0(S l) => [
        ...
        _PickerField(
          ...
          onTap: () async {
            ...
            if (picked != null && picked != _selMake) {
              _handleMakeChanged(picked);
            }
          },
        ),
        ...
        Container(
          ...
          child: Column(children: [
            ...
            if (_oemCtrl.text.isNotEmpty) ...[
              const Divider(height: 20),
              _ConfirmRow(
                  label: l.partNo, value: _oemCtrl.text.trim(), mono: true),
            ],
          ]),
        ),
        const SizedBox(height: 16),
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: const TextStyle(color: kTextMuted, fontSize: 14),
                prefixIcon:
                    const Icon(Icons.search, size: 18, color: kTextMuted),
                contentPadding:
    ...
    return Row(children: [
      for (int i = 0; i < 3; i++) ...[
        if (i > 0)
          Expanded(
              child:
                  Container(height: 2, color: i <= step ? kPrimary : kBorder)),
        Container(
          width: 28,
          height: 28,
          decoration: BoxDecoration(
...
class _Chip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: active ? kPrimary.withValues(alpha: 0.1) : Colors.white,
            borderRadius: BorderRadius.circular(20),
