...
const en: Translations = {
  ...
  landing: {
    ...
    pricingSub: 'Start free. Move to Pro when you need more.',
    planFreeName: 'Free',
    planFreeDesc: 'Core access at no cost.',
  ...
  onboarding: {
    ...
    choosePlanSub: 'Start free, or unlock Pro with a 7-day free trial.',
    ...
    planFreeDesc: 'Basic guide generation with limited history and no AI illustrations.',
    startMyFreeTrial: 'Start 7-day free trial',
  ...
  dashboard: {
    ...
    billingCancelledNotice: 'Checkout was canceled. You can start your trial anytime from Settings.',
  },
...
const uk: Translations = {
  ...
  nav: {
    ...
    features: 'Можливості',
    pricing: 'Ціни',
    startTrial: 'Спробувати безкоштовно',
  ...
  landing: {
    ...
    pricingSub: 'Почніть безкоштовно. Переходьте на Pro, коли потрібні ширші можливості.',
    planFreeName: 'Безкоштовний',
    planFreeDesc: 'Базовий доступ без оплати.',
    ...
    ctaStartTrial: 'Спробувати безкоштовно',
  ...
  onboarding: {
    ...
    choosePlanSub: 'Почніть безкоштовно або відкрийте Pro на 7-денний пробний період.',
    ...
    planFreeDesc: 'Базова генерація інструкцій, обмежена історія та без ШІ-ілюстрацій.',
  ...
  dashboard: {
    ...
    billingCancelledNotice: 'Оплату скасовано. Ви можете знову почати пробний період у Налаштуваннях у будь-який час.',
  },
...
const bg: Translations = {
  ...
  landing: {
    ...
    pricingSub: 'Започнете безплатно. Преминете към Pro, когато ви трябва повече.',
    planFreeName: 'Безплатен',
    planFreeDesc: 'Основен достъп без заплащане.',
    ...
    ctaStartTrial: 'Започнете безплатно',
  ...
  onboarding: {
    ...
    choosePlanSub: 'Започнете безплатно или отключете Pro с 7-дневен пробен период.',
    ...
    planFreeDesc: 'Базово генериране на ръководства, ограничена история и без ИИ илюстрации.',
  ...
  dashboard: {
    ...
    billingCancelledNotice: 'Плащането беше отменено. Можете да стартирате пробния период по всяко време от Настройки.',
  },
