...
export interface Translations {
  ...
  dash: {
    ...
    couldNotCreateGuide: string;
    couldNotDeleteGuide: string;
    noGuidesYet: string;
...
const en: Translations = {
  ...
  landing: {
    ...
    heroTitle: 'Repair intelligence',
    heroTitleGrad: 'for every vehicle.',
    heroSub: 'Ask any repair question. Motixi searches its repair knowledge base first. If the guide already exists, you get it instantly. If not, AI generates it and saves it for the next search.',
    searchPlaceholder: 'Search by vehicle, issue, or component…',
    tryLabel: 'Try:',
    recentLabel: 'Recent:',
    popularRepairs: 'Popular Repairs',
    guidesCount: 'guides',
    trustedBy: 'Used by teams at',
    howEyebrow: 'How it works',
    howTitle: 'From repair question to ready guide in four steps',
    step01title: 'Describe the job',
    step01text: 'Enter the vehicle model, issue, or part name — or type the request the way a technician would naturally ask it.',
    step02title: 'Motixi checks the knowledge base',
    step02text: 'Stored repair guides are searched first, so existing answers appear before anything new is generated.',
    step03title: 'Get the best available result',
    step03text: 'If the guide already exists, it appears instantly. If not, AI builds a new one in under 3 seconds.',
    step04title: 'Work step by step',
    step04text: 'Open the guide on web or mobile and follow each step with specs, tools, and diagrams inline.',
    statGeneration: 'Guide generation',
    statSteps: 'Steps per guide',
    statAiGenerated: 'AI-generated',
    statVehicleModels: 'Vehicle models',
    featuresEyebrow: 'Features',
    featuresTitle: 'Built for real repair work',
    featuresSub: 'Everything a technician needs to move from diagnosis to execution without switching tools.',
    feat1title: 'Instant guide generation',
    feat1desc: 'Turn a vehicle model and repair request into a complete, structured guide in under 3 seconds.',
    feat2title: 'Step-by-step precision',
    feat2desc: 'Clear ordered steps with torque specs, required tools, and safety warnings built in.',
    feat3title: 'Engineering diagrams',
    feat3desc: 'Technical diagrams are generated and shown exactly where they are needed in the procedure.',
    feat4title: 'Web & mobile',
    feat4desc: 'One shared platform powers both the web dashboard and the mobile app.',
    feat5title: 'Background job queue',
    feat5desc: 'Long-running generation tasks happen in the background while the app keeps the user informed in real time.',
    feat6title: 'Enterprise-ready',
    feat6desc: 'Enterprise-ready controls for teams, custom documentation, access management, and deployment at scale.',
    mobileEyebrow: 'Mobile App',
    mobileTitle: 'Repair guides\nwhere the work happens',
    mobileSub: 'The same Motixi guides, optimized for mobile. Move through procedures at the vehicle, zoom into diagrams, and keep progress visible while you work.',
    mobileBullet1: 'Swipe through steps with one hand',
    mobileBullet2: 'Zoom into diagrams without losing context',
    mobileBullet3: 'Keep working in low-connectivity workshop environments',
    ...
    pricingTitle: 'Simple pricing that scales with usage',
    pricingSub: 'Start with Demo, then sign up when you are ready for Pro access.',
    planFreeName: 'Demo',
    planFreeDesc: 'Read-only product tour with 3 real demo guides.',
    planFreeItem1: '3 demo guides',
    planFreeItem2: 'Search inside the demo set',
    planFreeItem3: 'Working filters from demo data',
    planFreeItem4: 'No signup required',
    planFreeGetStarted: 'Start demo',
    planProName: 'Pro',
    planProDesc: 'For technicians and busy workshops.',
    ...
    planProStartTrial: 'Start 7-day trial',
    planProMostPopular: 'Most popular',
    planEntName: 'Enterprise',
    planEntDesc: 'For fleets and service operations.',
    ...
    ctaTitle: 'Start with Demo, then unlock full repair workflows.',
    ctaSub: 'Start in Demo mode, then sign up when you are ready for full access.',
    ctaStartTrial: 'Sign up',
    ctaAlreadyHaveAccount: 'Log in →',
  ...
  authModal: {
    ...
    sub: 'Sign up for your own repair workspace, or enter Demo mode to explore 3 real demo guides.',
    createAccount: 'Sign up',
    signIn: 'Sign in',
    continueAsGuest: 'Start demo',
    guestLoadingText: 'Loading…',
    guestNote: 'Demo mode includes 3 real demo guides in read-only access.',
  },

  auth: {
    welcomeBack: 'Welcome back',
    noAccount: 'No account?',
    createOneFree: 'Sign up',
    ...
    guestFailed: 'Could not start demo mode',
  },
  ...
  onboarding: {
    ...
    choosePlanSub: 'Start your paid trial, or activate instantly with an approved promo code.',
    planTrialName: '7-day trial',
    planTrialDesc: 'Full access with AI illustrations, OEM-backed guides, and unlimited repairs.',
    ...
    planFreeName: 'Demo',
    planFreeDesc: 'Read-only Demo mode with 3 real demo guides.',
    startMyFreeTrial: 'Start 7-day trial',
    getPremiumAccess: 'Get Premium access',
    continueFree: 'Continue in Demo',
  ...
  dash: {
    sampleGuides: 'Demo Guides',
    guidesTitle: 'Guides',
    guidesSub: 'Your AI-generated repair guides',
    sampleGuidesSub: '3 real demo guides generated by Motixi — Demo mode only',
    newGuide: 'New Guide',
    guestBanner: "You're in Demo mode — these 3 real demo guides are fully interactive inside the demo set.",
    guestBannerLink: 'Sign up',
    guestBannerSuffix: 'to generate your own guides.',
    thisMonth: 'This month',
    timeSaved: 'Time saved',
    topRepair: 'Top repair',
    searchGuides: 'Search guides…',
    filterSampleGuides: 'Filter demo guides…',
    ...
    noSampleMatch: 'No demo guides match that filter',
    ...
    couldNotCreateGuide: 'Could not create guide',
    couldNotDeleteGuide: 'Could not delete guide',
  ...
  settingsView: {
    ...
    startTrialCta: 'Start 7-day trial — $39/mo after',
    guidesThisMonth: 'Guides this month',
    includesLabel: 'Includes',
    freePlanIncludes: 'Complete billing or apply an approved promo code',
    priceLabel: 'Price',
  ...
  guideDetail: {
    ...
    lockedPreviewSub: 'The rest of this guide unlocks after you complete signup and start your trial.',
    proPreview: 'Preview',
    availableInPro: 'Available in Pro',
    askAiUpgradeDesc: 'Complete signup and start your trial to ask follow-up questions, get guided explanations, and finish the repair without leaving the guide.',
  },
  ...
  profilePage: {
    ...
    startTrialCta: 'Start 7-day trial',
    unlimited: 'Unlimited',
  ...
  dashboard: {
    ...
    billingCancelledNotice: 'Checkout was canceled. Your signup is still pending until payment succeeds.',
  },
  ...
  aboutPage: {
    ...
    heroSub: 'Motixi is an AI platform that turns repair requests into structured guides in seconds — built by engineers who understand how workshops actually work.',

    storyEyebrow: 'Our Story',
    storyTitle: 'Why we built Motixi',
    storyP1: 'We came from enterprise consulting and software engineering, building platforms for banks, retailers, and technology companies. When we looked at automotive and heavy equipment, we saw teams buried in scattered PDFs, tribal knowledge, and outdated manuals. Technicians deserved better tools.',
    storyP2: 'That is why we built Motixi: an AI engine that turns a vehicle model and repair description into a complete step-by-step guide with torque specs, safety notes, and diagrams in under 3 seconds. No manual hunting. No guesswork. Just the right procedure, right when you need it.',

    leadershipEyebrow: 'Leadership',
    leadershipTitle: 'The team behind Motixi',
    ceoName: 'Kyrylo Petrov',
    ceoRole: 'Founder & CEO',
    ceoIntro: 'Product-minded founder building AI software for real operational teams.',
    ceoBullets: [
      '10+ years in enterprise consulting and digital transformation',
      'Built platforms for large organizations across finance and retail',
      'Focused on product strategy, execution, and go-to-market clarity',
      'Founded Motixi to solve real problems in repair operations',
    ],
    ctoName: 'Mykhailo Shanahin',
    ctoRole: 'CTO & Co-Founder',
    ctoIntro: 'CTO and systems architect with 20+ years of experience building reliable, scalable software.',
    ctoBullets: [
      'Designed and delivered large-scale distributed systems',
      'Deep expertise in backend architecture, reliability, and performance',
      'Leads engineering at Motixi from infrastructure through product delivery',
      'Built and scaled engineering teams across complex software products',
    ],
    ...
    whyCards: [
      ...
      { icon: '🚫', title: 'No noise', desc: 'No stack of outdated manuals. No patchwork of disconnected tools. One product that helps you work faster.' },
    ],
  ...
  productPage: {
    ...
    sub: 'Enter a vehicle model and repair description. Get a complete step-by-step procedure with torque specs, tools, safety warnings, and engineering diagrams in under 3 seconds.',
    startTrial: 'Sign up',
    tryDemo: 'Start demo',
    talkToFounder: 'Contact us →',
    ...
    walkthroughSub: 'Available on web and mobile with the same AI and the same accuracy.',
    step01: 'Step 01',
    ...
    step02desc: 'Motixi searches the knowledge base first. Existing matches appear instantly, and new guides are generated in under 3 seconds.',
    step03: 'Step 03',
    ...
    whoSub: 'From independent technicians to enterprise fleet workshops.',
    forCards: [
    ...
    guideOutputTitle: 'Everything a technician needs, clearly structured',
    ...
    differentiators: [
      ...
      { vs: 'vs forum threads', title: 'Authoritative, not anecdotal', desc: 'Built from structured repair knowledge, not forum opinions that may miss your exact vehicle or trim.' },
    ...
    ctaEyebrow: 'Get started today',
    ctaTitle: 'Explore the product in Demo, then sign up when you need full access.',
  ...
  contactPage: {
    eyebrow: 'Contact',
    title: 'Contact us',
    sub: 'For partnerships, enterprise deployments, consulting, or product questions about Motixi — I reply personally.',
    founderName: 'Kyrylo Petrov',
    founderRole: 'Founder & CEO, Motixi',
    email: 'Email',
    linkedin: 'LinkedIn',
    getInTouchTitle: 'Get in touch directly',
    getInTouchP1: 'I reply personally to every message. If you are evaluating Motixi for your workshop, planning an enterprise rollout, exploring consulting support, or discussing a partnership, I am happy to talk.',
    getInTouchP2: 'Email is the fastest way to reach me. LinkedIn also works if you prefer a more formal introduction.',
...
const uk: Translations = {
  ...
  landing: {
    ...
    heroTitleGrad: 'для будь-якої техніки.',
    heroSub: 'Поставте будь-яке запитання щодо ремонту. Motixi спочатку шукає відповідь у своїй базі знань. Якщо інструкція вже існує, ви отримуєте її миттєво. Якщо ні — ШІ генерує нову й зберігає її для наступного запиту.',
    ...
    trustedBy: 'Motixi використовують команди',
    howEyebrow: 'Як це працює',
    howTitle: 'Від ремонтного запиту до готової інструкції за чотири кроки',
    step01title: 'Опишіть задачу',
    step01text: 'Вкажіть модель техніки, несправність або деталь — або напишіть запит так, як це зробив би майстер.',
    step02title: 'Motixi перевіряє базу знань',
    step02text: 'Система спочатку шукає вже збережені інструкції, щоб готові відповіді з’являлися без зайвої генерації.',
    step03title: 'Отримайте найкращий результат',
    step03text: 'Якщо інструкція вже існує, ви бачите її миттєво. Якщо ні — ШІ створює нову менш ніж за 3 секунди.',
    step04title: 'Працюйте крок за кроком',
    step04text: 'Відкрийте інструкцію на вебі чи мобільному та виконуйте роботу з моментами затяжки, інструментами й схемами під рукою.',
    ...
    featuresTitle: 'Створено для реальної ремонтної роботи',
    featuresSub: 'Усе, що потрібно техніку, щоб перейти від діагностики до виконання без перемикання між інструментами.',
    feat1title: 'Миттєва генерація',
    feat1desc: 'Перетворюйте модель техніки та опис ремонту на повну структуровану інструкцію менш ніж за 3 секунди.',
    feat2title: 'Покрокова точність',
    feat2desc: 'Чіткі впорядковані кроки з моментами затяжки, потрібними інструментами та попередженнями з безпеки.',
    feat3title: 'Інженерні діаграми',
    feat3desc: 'Технічні схеми генеруються і показуються саме там, де вони потрібні в процедурі.',
    feat4title: 'Веб та мобільний',
    feat4desc: 'Одна спільна платформа працює і для вебпанелі, і для мобільного застосунку.',
    feat5title: 'Фонова черга завдань',
    feat5desc: 'Тривалі задачі генерації виконуються у фоні, а користувач бачить актуальний статус у реальному часі.',
    feat6title: 'Готово для підприємств',
    feat6desc: 'Рішення готове для команд: керування доступами, власна документація, ізоляція середовищ і масштабне розгортання.',
    mobileEyebrow: 'Мобільний додаток',
    mobileTitle: 'Інструкції з ремонту\nтам, де виконується робота',
    mobileSub: 'Ті самі інструкції Motixi, адаптовані для мобільного. Переходьте між кроками біля техніки, збільшуйте схеми та тримайте прогрес під контролем під час роботи.',
    mobileBullet1: 'Перемикайте кроки однією рукою',
    mobileBullet2: 'Збільшуйте схеми, не втрачаючи контексту',
    mobileBullet3: 'Працюйте навіть у майстернях зі слабким зв’язком',
    ...
    pricingEyebrow: 'Ціни',
    pricingTitle: 'Прості ціни, що масштабуються разом із використанням',
    pricingSub: 'Почніть з демо, а коли будете готові до повного доступу — зареєструйтесь.',
    planFreeName: 'Демо',
    planFreeDesc: 'Режим перегляду з 3 реальними демо-інструкціями.',
    planFreeItem1: '3 демо-інструкції',
    planFreeItem2: 'Пошук лише в демо-наборі',
    planFreeItem3: 'Фільтри працюють по демо-даних',
    planFreeItem4: 'Без реєстрації',
    planFreeGetStarted: 'Почати демо',
    planProName: 'Pro',
    planProDesc: 'Для техніків і сервісів, які працюють щодня.',
    ...
    planProStartTrial: 'Почати 7-денний пробний період',
    planProMostPopular: 'Найпопулярніший',
    planEntName: 'Enterprise',
    planEntDesc: 'Для автопарків і сервісних команд.',
    ...
    ctaTitle: 'Почніть із демо, а повний ремонтний процес відкрийте після реєстрації.',
    ctaSub: 'Без кредитної картки. Без налаштування. Тільки результат.',
    ctaStartTrial: 'Зареєструватися',
    ctaAlreadyHaveAccount: 'Увійти →',
  ...
  authModal: {
    ...
    sub: 'Зареєструйтесь для власного робочого простору або увійдіть у демо-режим, щоб переглянути 3 реальні демо-інструкції.',
    createAccount: 'Зареєструватися',
    signIn: 'Увійти',
    continueAsGuest: 'Почати демо',
    guestLoadingText: 'Завантаження…',
    guestNote: 'Демо-режим містить 3 реальні демо-інструкції в режимі перегляду.',
  },

  auth: {
    welcomeBack: 'З поверненням',
    noAccount: 'Немає акаунту?',
    createOneFree: 'Зареєструватися',
    ...
    guestFailed: 'Не вдалося запустити демо',
  },
  ...
  onboarding: {
    ...
    choosePlanSub: 'Запустіть платний пробний період або активуйте доступ схваленим промокодом.',
    planTrialName: '7-денний пробний період',
    planTrialDesc: 'Повний доступ із ШІ-ілюстраціями, інструкціями на основі OEM-даних і необмеженою кількістю ремонтів.',
    ...
    planFreeName: 'Демо',
    planFreeDesc: 'Демо-режим лише для перегляду з 3 реальними демо-інструкціями.',
    startMyFreeTrial: 'Почати 7-денний пробний період',
    getPremiumAccess: 'Отримати Преміум доступ',
    continueFree: 'Продовжити в демо-режимі',
  ...
  dash: {
    ...
    sampleGuidesSub: '3 реальні демо-інструкції від Motixi — лише демо-режим',
    newGuide: 'Нова інструкція',
    guestBanner: 'Ви в демо-режимі — це 3 реальні демо-інструкції.',
    guestBannerLink: 'Зареєструватися',
    guestBannerSuffix: 'щоб генерувати власні інструкції.',
    thisMonth: 'Цього місяця',
    timeSaved: 'Збережений час',
    topRepair: 'Найчастіший ремонт',
    ...
    couldNotCreateGuide: 'Не вдалося створити інструкцію',
    couldNotDeleteGuide: 'Не вдалося видалити інструкцію',
  ...
  settingsView: {
    ...
    planPro: 'План — Pro',
    proPlanTitle: 'Pro',
    trialPlanTitle: 'Пробний період Pro',
    freePlanTitle: 'Активація очікується',
    ...
    startTrialCta: 'Почати 7-денний пробний період — потім $39/міс',
    guidesThisMonth: 'Інструкції цього місяця',
    includesLabel: 'Включено',
    freePlanIncludes: 'Завершіть оплату або застосуйте схвалений промокод',
    priceLabel: 'Ціна',
  ...
  sidebar: {
    sampleGuides: 'Демо-інструкції',
    createFreeAccount: 'Зареєструватися',
    newGuide: 'Нова інструкція',
    workshop: 'МАЙСТЕРНЯ',
    jobs: 'Роботи',
    requests: 'Запити',
  ...
  guideForm: {
    ...
    taskOilChange: 'Заміна моторного масла та масляного фільтра',
  ...
  guideDetail: {
    ...
    generatingStatus: 'Генеруємо ілюстрацію...',
    ...
    startFreeTrial: 'Почати 7-денний пробний період',
    lockedPreviewSub: 'Решта інструкції відкриється після завершення реєстрації та запуску пробного періоду.',
    proPreview: 'Превʼю',
    availableInPro: 'Доступно в Pro',
    askAiUpgradeDesc: 'Завершіть реєстрацію та запустіть пробний період, щоб ставити уточнювальні питання, отримувати пояснення кроків і завершити ремонт без зайвих перемикань.',
  },
  ...
  dashboard: {
    trialStartedNotice: 'Ваш 7-денний Pro-пробний період активний. Користуйтеся повним доступом.',
    proActivatedNotice: 'Pro-план активовано! Тепер у вас необмежений доступ.',
    billingCancelledNotice: 'Оплату скасовано. Реєстрація залишилась у стані очікування, доки платіж не буде завершено.',
  },
  ...
  aboutPage: {
    ...
    heroSub: 'Motixi — це ШІ-платформа, що перетворює ремонтний запит на структуровану інструкцію за секунди. Її створили інженери, які добре розуміють реальну роботу сервісів.',

    storyEyebrow: 'Наша історія',
    storyTitle: 'Чому ми створили Motixi',
    storyP1: 'Ми прийшли з корпоративного консалтингу та розробки програмного забезпечення, де будували платформи для банків, ритейлу й технологічних компаній. Коли ми подивилися на автомобільну галузь і важку техніку, побачили команди, які тонуть у розрізнених PDF-файлах, неформальних знаннях і застарілих мануалах. Технікам потрібні кращі інструменти.',
    storyP2: 'Саме тому ми створили Motixi: ШІ-двигун, який перетворює модель транспортного засобу й опис ремонту на повну покрокову інструкцію з моментами затяжки, примітками з безпеки та схемами менш ніж за 3 секунди. Без ручного пошуку. Без здогадок. Лише правильна процедура саме тоді, коли вона потрібна.',

    leadershipEyebrow: 'Команда',
    leadershipTitle: 'Люди за Motixi',
    ceoName: 'Кирило Петров',
    ceoRole: 'Засновник та CEO',
    ceoIntro: 'Продуктовий підприємець, який створює AI-рішення для реальних операційних команд.',
    ceoBullets: [
      '10+ років у корпоративному консалтингу та цифровій трансформації',
      'Створював платформи для великих компаній у фінансах і ритейлі',
      'Сильний фокус на продуктовій стратегії, реалізації та виході на ринок',
      'Заснував Motixi, щоб вирішувати реальні проблеми ремонтних команд',
    ],
    ctoName: 'Михайло Шанахін',
    ctoRole: 'CTO & співзасновник',
    ctoIntro: 'CTO та архітектор систем із 20+ роками досвіду створення надійного й масштабованого програмного забезпечення.',
    ctoBullets: [
      'Проєктував та запускав великомасштабні розподілені системи',
      'Глибока експертиза в бекенд-архітектурі, надійності та продуктивності систем',
      'Очолює інженерію в Motixi від інфраструктури до продуктового релізу',
      'Будував і масштабував інженерні команди для складних програмних продуктів',
    ],
    linkedinLabel: 'LinkedIn',
    emailLabel: 'Email',
    ...
    whyCards: [
      ...
      { icon: '🚫', title: 'Без шуму', desc: 'Без стосу застарілих мануалів. Без набору розрізнених інструментів. Один продукт, який реально пришвидшує роботу.' },
    ],
  ...
  productPage: {
    ...
    sub: 'Вкажіть модель транспортного засобу та опишіть ремонт. Отримайте повну покрокову процедуру з моментами затяжки, інструментами, попередженнями з безпеки та схемами менш ніж за 3 секунди.',
    startTrial: 'Зареєструватися',
    tryDemo: 'Почати демо',
    talkToFounder: 'Зв\'язатися з нами →',
    ...
    walkthroughSub: 'Доступно на вебі й мобільному з тим самим ШІ та тією самою точністю.',
    step01: 'Крок 01',
    ...
    step02desc: 'Motixi спочатку шукає в базі знань. Готові збіги з\'являються миттєво, а нові інструкції генеруються менш ніж за 3 секунди.',
    step03: 'Крок 03',
    ...
    whoSub: 'Від незалежних майстрів до корпоративних сервісних команд.',
    forCards: [
      ...
      { icon: '🏭', label: 'Сервісні команди', desc: 'Стандартизуйте ремонтні процедури для всієї команди завдяки послідовним крокам, згенерованим ШІ.' },
    ...
    guideOutputTitle: 'Усе, що потрібно техніку, уже структуровано',
    ...
    differentiators: [
      { vs: 'проти PDF-мануалів', title: 'Пошук. Миттєво. Структуровано.', desc: 'Без завантаження. Без гортання сотень сторінок. Природна мова на вході, чітка процедура на виході.' },
      { vs: 'проти форумів', title: 'Авторитетно, а не навмання', desc: 'Рішення спирається на структуровані ремонтні знання, а не на поради з форумів, які можуть не підходити до вашої комплектації.' },
    ...
    ctaEyebrow: 'Почніть сьогодні',
    ctaTitle: 'Перегляньте продукт у демо-режимі, а коли знадобиться повний доступ — зареєструйтесь.',
    ctaSub: 'Без кредитної картки. Без налаштування. Тільки результати.',
    alreadyHaveAccount: 'Увійти →',
  },

  contactPage: {
    eyebrow: 'Контакти',
    title: 'Зв\'язатися з нами',
    sub: 'Партнерства, корпоративні впровадження, консалтинг чи питання про продукт Motixi — відповідаю особисто.',
    founderName: 'Кирило Петров',
    founderRole: 'Засновник та CEO, Motixi',
    email: 'Email',
    linkedin: 'LinkedIn',
    getInTouchTitle: 'Зв\'яжіться напряму',
    getInTouchP1: 'Я відповідаю особисто на кожне повідомлення. Якщо ви оцінюєте Motixi для свого сервісу, плануєте корпоративне впровадження, шукаєте консультацію чи хочете обговорити партнерство, я на зв\'язку.',
    getInTouchP2: 'Найшвидше написати на email. LinkedIn також підійде, якщо вам зручніший формальніший формат знайомства.',
    responseNote: 'Зазвичай відповідаю протягом 24 годин.',
  },
...
const bg: Translations = {
  ...
  landing: {
    ...
    heroTitle: 'Ремонтно знание',
    heroTitleGrad: 'за всяко превозно средство.',
    heroSub: 'Задайте всеки въпрос за ремонт. Motixi първо търси в своята база знания. Ако ръководството вече съществува, го получавате веднага. Ако не, ИИ го генерира и го запазва за следващото търсене.',
    ...
    trustedBy: 'Motixi се използва от екипи в',
    howEyebrow: 'Как работи',
    howTitle: 'От ремонтен въпрос до готово ръководство в четири стъпки',
    step01title: 'Опишете задачата',
    step01text: 'Въведете модела на машината, проблема или частта — или напишете заявката така, както би го направил техник.',
    step02title: 'Motixi проверява базата знания',
    step02text: 'Системата първо търси вече запазени ръководства, така че готовите отговори да се появят преди ново генериране.',
    step03title: 'Получавате най-добрия резултат',
    step03text: 'Ако ръководството вече съществува, го виждате веднага. Ако не, ИИ създава ново за по-малко от 3 секунди.',
    step04title: 'Работете стъпка по стъпка',
    step04text: 'Отворете ръководството на уеб или мобилно и изпълнявайте задачата с точните спецификации, инструменти и диаграми под ръка.',
    ...
    featuresTitle: 'Създадено за реална ремонтна работа',
    featuresSub: 'Всичко необходимо на техника, за да премине от диагностика към изпълнение без смяна на инструменти и екрани.',
    feat1title: 'Моментално генериране',
    feat1desc: 'Превърнете модел на машина и описание на ремонта в пълно структурирано ръководство за по-малко от 3 секунди.',
    feat2title: 'Прецизност стъпка по стъпка',
    feat2desc: 'Ясни подредени стъпки с моменти на затягане, нужните инструменти и предупреждения за безопасност.',
    feat3title: 'Инженерни диаграми',
    feat3desc: 'Техническите диаграми се генерират и показват точно там, където са нужни в процедурата.',
    feat4title: 'Уеб и мобилен',
    feat4desc: 'Една обща платформа захранва и уеб таблото, и мобилното приложение.',
    feat5title: 'Фонова опашка за задачи',
    feat5desc: 'По-дългите задачи за генериране се изпълняват във фонов режим, а статусът остава видим в реално време.',
    feat6title: 'Готово за предприятия',
    feat6desc: 'Решение, готово за екипи: управление на достъп, собствена документация, изолирани среди и мащабируемо внедряване.',
    mobileEyebrow: 'Мобилно приложение',
    mobileTitle: 'Ремонтни ръководства\nтам, където се върши работата',
    mobileSub: 'Същите ръководства на Motixi, оптимизирани за мобилен. Преминавайте през стъпките до самата машина, увеличавайте диаграмите и следете прогреса, докато работите.',
    mobileBullet1: 'Преминавайте през стъпките с една ръка',
    mobileBullet2: 'Увеличавайте диаграмите, без да губите контекст',
    mobileBullet3: 'Работете и при слаба свързаност в сервиза',
    ...
    pricingEyebrow: 'Цени',
    pricingTitle: 'Прости цени, които растат с използването',
    pricingSub: 'Започнете с демо, а когато сте готови за пълен достъп — регистрирайте се.',
    planFreeName: 'Демо',
    planFreeDesc: 'Режим само за преглед с 3 реални демо ръководства.',
    planFreeItem1: '3 демо ръководства',
    planFreeItem2: 'Търсене само в демо набора',
    planFreeItem3: 'Филтри по реалните демо данни',
    planFreeItem4: 'Без регистрация',
    planFreeGetStarted: 'Стартирай демо',
    planProName: 'Pro',
    planProDesc: 'За техници и натоварени сервизи.',
    ...
    planProStartTrial: 'Стартирай 7-дневен пробен период',
    planProMostPopular: 'Най-популярен',
    planEntName: 'Enterprise',
    planEntDesc: 'За автопаркове и сервизни операции.',
    ...
    ctaTitle: 'Започнете с демо, а пълния ремонтен поток отключете след регистрация.',
    ctaSub: 'Без кредитна карта. Без настройка. Само резултати.',
    ctaStartTrial: 'Регистрация',
    ctaAlreadyHaveAccount: 'Влезте →',
  ...
  authModal: {
    ...
    sub: 'Регистрирайте се за собствено работно пространство или влезте в демо режим, за да разгледате 3 реални демо ръководства.',
    createAccount: 'Регистрация',
    signIn: 'Вход',
    continueAsGuest: 'Стартирай демо',
    guestLoadingText: 'Зареждане…',
    guestNote: 'Демо режимът включва 3 реални демо ръководства в режим само за четене.',
  },

  auth: {
    welcomeBack: 'Добре дошли отново',
    noAccount: 'Нямате акаунт?',
    createOneFree: 'Регистрация',
    ...
    guestFailed: 'Демо режимът не можа да бъде стартиран',
  },
  ...
  onboarding: {
    ...
    choosePlanSub: 'Стартирайте платения пробен период или активирайте достъпа с одобрен промокод.',
    planTrialName: '7-дневен пробен период',
    planTrialDesc: 'Пълен достъп с ИИ илюстрации, OEM-базирани ръководства и неограничени ремонти.',
    ...
    planFreeName: 'Демо',
    planFreeDesc: 'Демо режим само за преглед с 3 реални демо ръководства.',
    startMyFreeTrial: 'Стартирайте 7-дневния пробен период',
    getPremiumAccess: 'Вземи Премиум достъп',
    continueFree: 'Продължи в демо режим',
  ...
  dash: {
    ...
    sampleGuidesSub: '3 реални демо ръководства от Motixi — само в демо режим',
    newGuide: 'Ново ръководство',
    guestBanner: 'Вие сте в демо режим — това са 3 реални демо ръководства.',
    guestBannerLink: 'Регистрация',
    guestBannerSuffix: 'за да генерирате свои ръководства.',
    ...
    couldNotCreateGuide: 'Не успяхме да създадем ръководството',
    couldNotDeleteGuide: 'Не успяхме да изтрием ръководството',
  ...
  settingsView: {
    ...
    planPro: 'План — Pro',
    proPlanTitle: 'Pro',
    trialPlanTitle: 'Пробен период Pro',
    freePlanTitle: 'Активацията е в изчакване',
    ...
    contactBillingSupport: 'Свържете се с поддръжката за плащания',
    startTrialCta: 'Стартирайте 7-дневен пробен период — след това $39/мес',
    guidesThisMonth: 'Ръководства този месец',
    includesLabel: 'Включва',
    freePlanIncludes: 'Завършете плащането или приложете одобрен промокод',
    priceLabel: 'Цена',
  ...
  sidebar: {
    ...
    pro: 'Pro ✓',
    trial: 'Пробен Pro',
    free: 'Активирането е в изчакване',
  ...
  guideDetail: {
    ...
    startFreeTrial: 'Стартирай 7-дневен пробен период',
    lockedPreviewSub: 'Останалата част от ръководството се отключва след завършена регистрация и стартиран пробен период.',
    proPreview: 'Преглед',
    availableInPro: 'Налично в Pro',
    askAiUpgradeDesc: 'Завършете регистрацията и стартирайте пробния период, за да задавате уточняващи въпроси, да получавате ясни обяснения и да завършите ремонта в един поток.',
  },
  ...
  profilePage: {
    ...
    freePlan: '⚡ Активацията е в изчакване',
    proPlan: '⚡ Pro план — $39/мес',
    enterprisePlan: '🏢 Корпоративен план',
    freePlanTitle: 'Активацията е в изчакване',
    proPlanTitle: 'Pro',
    trialPlanTitle: 'Пробен период Pro',
  ...
  dashboard: {
    trialStartedNotice: 'Вашият 7-дневен Pro пробен период е активен. Насладете се на пълния достъп.',
    proActivatedNotice: 'Pro планът е активиран! Вече имате неограничен достъп.',
    billingCancelledNotice: 'Плащането беше отменено. Регистрацията остава в изчакване, докато плащането не бъде завършено.',
  },
  ...
  aboutPage: {
    ...
    heroSub: 'Motixi е AI платформа, която превръща ремонтното запитване в структурирано ръководство за секунди — създадена от инженери, които познават реалната работа в сервизите.',

    storyEyebrow: 'Нашата история',
    storyTitle: 'Защо създадохме Motixi',
    storyP1: 'Идваме от корпоративен консултинг и софтуерно инженерство, където изграждахме платформи за банки, ритейл и технологични компании. Когато погледнахме към автомобилната индустрия и тежката техника, видяхме екипи, затрупани с разпръснати PDF файлове, устни знания и остарели наръчници. Техниците заслужават по-добри инструменти.',
    storyP2: 'Затова създадохме Motixi: AI двигател, който превръща модел на превозно средство и описание на ремонта в пълно ръководство стъпка по стъпка с моменти на затягане, бележки за безопасност и диаграми за по-малко от 3 секунди. Без ръчно търсене. Без догадки. Само правилната процедура точно когато ви е нужна.',

    leadershipEyebrow: 'Екип',
    leadershipTitle: 'Хората зад Motixi',
    ceoName: 'Кирило Петров',
    ceoRole: 'Основател и CEO',
    ceoIntro: 'Продуктов предприемач, който изгражда AI решения за реални оперативни екипи.',
    ceoBullets: [
      ...
      'Силен фокус върху продуктова стратегия, изпълнение и излизане на пазара',
      'Създаде Motixi, за да решава реални проблеми на ремонтните екипи',
    ],
    ctoName: 'Михайло Шанахин',
    ctoRole: 'CTO & съосновател',
    ctoIntro: 'CTO и системен архитект с над 20 години опит в изграждането на надежден и мащабируем софтуер.',
    ctoBullets: [
      'Проектирал и доставял мащабни разпределени системи',
      'Дълбока експертиза в бекенд архитектура, надеждност и производителност на системи',
      'Ръководи инженерния екип в Motixi от инфраструктурата до продуктовото доставяне',
      'Изграждал и мащабирал инженерни екипи за сложни софтуерни продукти',
    ],
    linkedinLabel: 'LinkedIn',
    emailLabel: 'Email',
    ...
    whyCards: [
      ...
      { icon: '🚫', title: 'Без шум', desc: 'Без куп остарели наръчници. Без комплект от разпокъсани инструменти. Един продукт, който реално ускорява работата.' },
    ],
  ...
  productPage: {
    ...
    sub: 'Въведете модел на превозно средство и описание на ремонта. Получете пълна процедура стъпка по стъпка с моменти на затягане, инструменти, предупреждения за безопасност и инженерни диаграми за по-малко от 3 секунди.',
    startTrial: 'Регистрация',
    tryDemo: 'Стартирай демо',
    talkToFounder: 'Свържете се с нас →',
    ...
    walkthroughSub: 'На уеб и мобилно с един и същ AI и една и съща точност.',
    step01: 'Стъпка 01',
    ...
    step02desc: 'Motixi първо търси в базата знания. Готовите съвпадения се появяват веднага, а новите ръководства се генерират за по-малко от 3 секунди.',
    step03: 'Стъпка 03',
    ...
    whoTitle: 'Създадено за хората, които ремонтират',
    whoSub: 'От независими техници до корпоративни сервизни екипи.',
    forCards: [
      ...
      { icon: '🏭', label: 'Сервизни екипи', desc: 'Стандартизирайте ремонтните процедури за целия екип с последователни стъпки, генерирани от AI.' },
    ...
    guideOutputTitle: 'Всичко необходимо на техника, ясно структурирано',
    ...
    differentiators: [
      { vs: 'срещу PDF ръководства', title: 'Търсене. Мигновено. Структурирано.', desc: 'Без изтегляне. Без прелистване на стотици страници. Естествен език на входа, ясна процедура на изхода.' },
      { vs: 'срещу форуми', title: 'Авторитетно, не по слухове', desc: 'Решението е изградено върху структурирано ремонтно знание, а не върху мнения от форуми, които може да не пасват на вашата конфигурация.' },
    ...
    ctaEyebrow: 'Започнете днес',
    ctaTitle: 'Разгледайте продукта в демо режим, а когато ви трябва пълен достъп — регистрирайте се.',
    ctaSub: 'Без кредитна карта. Без настройка. Само резултати.',
    alreadyHaveAccount: 'Влезте →',
  },

  contactPage: {
    eyebrow: 'Контакти',
    title: 'Свържете се с нас',
    sub: 'За партньорства, корпоративни внедрявания, консултации или продуктови въпроси за Motixi — отговарям лично.',
    founderName: 'Кирило Петров',
    founderRole: 'Основател и CEO, Motixi',
    email: 'Имейл',
    linkedin: 'LinkedIn',
    getInTouchTitle: 'Свържете се директно',
    getInTouchP1: 'Отговарям лично на всяко съобщение. Ако оценявате Motixi за вашия сервиз, планирате корпоративно внедряване, търсите консултантска подкрепа или искате да обсъдите партньорство, с удоволствие ще поговорим.',
    getInTouchP2: 'Имейлът е най-бързият начин да се свържете с мен. LinkedIn също е добър вариант, ако предпочитате по-официално представяне.',
    responseNote: 'Обикновено отговарям в рамките на 24 часа.',
  },
