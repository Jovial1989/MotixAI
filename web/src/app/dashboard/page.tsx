  ...
  return (
    <div className="dv-guides">
      ...
      <div className="dv-header">
        <div>
          <h1 className="dv-title">{isGuest ? 'Sample Guides' : 'Guides'}</h1>
          <p className="dv-sub">{isGuest ? '3 real guides generated by Motixi — read-only demo' : 'Your AI-generated repair guides'}</p>
        </div>
        {!isGuest && (
      ...
      {isGuest && (
        <div className="guest-banner">
          ...
          You&apos;re in demo mode — these are real guides.{' '}
          <Link href="/auth/signup" className="guest-banner-link">Create a free account</Link>
      ...
      <div className="glist-toolbar">
        <div className="glist-search-wrap">
          ...
          <input
            ...
            placeholder={isGuest ? 'Filter sample guides…' : 'Search guides…'}
            value={search}
      ...
      <section className="guide-list">
        {loading && guides.length === 0 ? (
          ...
          <div className="guide-list-empty">
            <p className="guide-empty-title">No sample guides match that filter</p>
            <p className="guide-empty-sub">Try a different keyword or clear the filter.</p>
          ...
          <div className="guide-list-empty">
            <p className="guide-empty-title">No results for &ldquo;{search}&rdquo;</p>
...
function GarageView({ vehicles, loading }: { vehicles: VehicleWithHistory[]; loading: boolean }) {
  return (
    <div className="dv-guides">
      <div className="dv-header">
        <div>
          <h1 className="dv-title">Vehicles</h1>
      ...
      {loading ? (
        ...
        <div className="guide-list-empty">
          ...
          <p className="guide-empty-sub">Generate a guide to add a vehicle.</p>
        </div>
      ) : (
